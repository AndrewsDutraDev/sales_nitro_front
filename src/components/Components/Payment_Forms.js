    ...
    return (
        <View style={style.container}>
            ...
            <View style={style.container_info}>
                <RadioButton value="Boleto" color='#0066FF' uncheckedColor='#0066FF'
                        status={ paymentForm === 'Boleto' ? 'checked' : 'unchecked' }
                        onPress={() => setPaymentForm('Boleto')}
                    />
                <Text style={style.label_input}>Boleto Bancário</Text>
            </View>
